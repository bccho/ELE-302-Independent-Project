...
\begin{itemize}
    ...
    \item Accelerometer and gyroscope % TODO: TJ to specify
    \item Light sensor: photoresistor and bright LEDs % TODO: TJ to specify
    ...
    \item Servo for changing angle of table tennis paddle % TODO: TJ to specify
    \item Any structural components we will need for the servo % TODO: TJ to specify
\end{itemize}
